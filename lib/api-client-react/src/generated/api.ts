...
export const createDemoSession = async ( options?: RequestInit): Promise<AuthResponse> => {
...
export const getCreateDemoSessionMutationOptions = <TError = ErrorType<unknown>,
 ...
 * @summary Create a temporary empty demo session
 */
export const useCreateDemoSession = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createDemoSession>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getChatbotConfig = async ( options?: RequestInit): Promise<ChatbotConfig> => {
...
export const getGetChatbotConfigQueryOptions = <TData = Awaited<ReturnType<typeof getChatbotConfig>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getChatbotConfig>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetChatbotConfigQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getChatbotConfig>>> = ({ signal }) => getChatbotConfig({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getChatbotConfig>>, TError, TData> & { queryKey: QueryKey }
}

export type GetChatbotConfigQueryResult = NonNullable<Awaited<ReturnType<typeof getChatbotConfig>>>
...
export function useGetChatbotConfig<TData = Awaited<ReturnType<typeof getChatbotConfig>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getChatbotConfig>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const updateChatbotConfig = async (updateChatbotConfigBody: UpdateChatbotConfigBody, options?: RequestInit): Promise<ChatbotConfig> => {
...
export const getUpdateChatbotConfigMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateChatbotConfig>>, TError,{data: BodyType<UpdateChatbotConfigBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateChatbotConfig>>, TError,{data: BodyType<UpdateChatbotConfigBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateChatbotConfig>>, {data: BodyType<UpdateChatbotConfigBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateChatbotConfigMutationResult = NonNullable<Awaited<ReturnType<typeof updateChatbotConfig>>>
 ...
 * @summary Update chatbot configuration
 */
export const useUpdateChatbotConfig = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateChatbotConfig>>, TError,{data: BodyType<UpdateChatbotConfigBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const connectWhatsapp = async ( options?: RequestInit): Promise<WhatsappConnectResponse> => {
...
export const getTrainingDocuments = async ( options?: RequestInit): Promise<TrainingDocument[]> => {
...
export const getGetTrainingDocumentsQueryOptions = <TData = Awaited<ReturnType<typeof getTrainingDocuments>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTrainingDocuments>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTrainingDocumentsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTrainingDocuments>>> = ({ signal }) => getTrainingDocuments({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTrainingDocuments>>, TError, TData> & { queryKey: QueryKey }
}

export type GetTrainingDocumentsQueryResult = NonNullable<Awaited<ReturnType<typeof getTrainingDocuments>>>
...
export function useGetTrainingDocuments<TData = Awaited<ReturnType<typeof getTrainingDocuments>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTrainingDocuments>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const uploadTrainingDocument = async (uploadTrainingDocumentBody: UploadTrainingDocumentBody, options?: RequestInit): Promise<TrainingDocument> => {
...
export const getUploadTrainingDocumentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof uploadTrainingDocument>>, TError,{data: BodyType<UploadTrainingDocumentBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof uploadTrainingDocument>>, TError,{data: BodyType<UploadTrainingDocumentBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof uploadTrainingDocument>>, {data: BodyType<UploadTrainingDocumentBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UploadTrainingDocumentMutationResult = NonNullable<Awaited<ReturnType<typeof uploadTrainingDocument>>>
    export type UploadTrainingDocumentMutationBody = BodyType<UploadTrainingDocumentBody>
    export type UploadTrainingDocumentMutationError = ErrorType<unknown>

    /**
 * @summary Upload a training document
 */
export const useUploadTrainingDocument = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof uploadTrainingDocument>>, TError,{data: BodyType<UploadTrainingDocumentBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const deleteTrainingDocument = async (id: number, options?: RequestInit): Promise<void> => {
...
export const getDeleteTrainingDocumentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteTrainingDocument>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteTrainingDocument>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteTrainingDocument>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteTrainingDocumentMutationResult = NonNullable<Awaited<ReturnType<typeof deleteTrainingDocument>>>
 ...
 * @summary Delete a training document
 */
export const useDeleteTrainingDocument = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteTrainingDocument>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const getGetConversationMessagesUrl = (contactId: number,
  ...
  return stringifiedParams.length > 0 ? `/api/conversations/${contactId}/messages?${stringifiedParams}` : `/api/conversations/${contactId}/messages`
}

export const getConversationMessages = async (contactId: number,
    params?: GetConversationMessagesParams, options?: RequestInit): Promise<ConversationMessage[]> => {

  return customFetch<ConversationMessage[]>(getGetConversationMessagesUrl(contactId,params),
  {
    ...options,
    method: 'GET'
...
export const getGetConversationMessagesQueryKey = (contactId: number,
    params?: GetConversationMessagesParams,) => {
    return [
    `/api/conversations/${contactId}/messages`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetConversationMessagesQueryOptions = <TData = Awaited<ReturnType<typeof getConversationMessages>>, TError = ErrorType<unknown>>(contactId: number,
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetConversationMessagesQueryKey(contactId,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getConversationMessages>>> = ({ signal }) => getConversationMessages(contactId,params, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(contactId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getConversationMessages>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetConversationMessages<TData = Awaited<ReturnType<typeof getConversationMessages>>, TError = ErrorType<unknown>>(
 contactId: number,
  ...
  const queryOptions = getGetConversationMessagesQueryOptions(contactId,params,options)
...
export const sendConversationMessage = async (contactId: number,
    sendMessageBody: SendMessageBody, options?: RequestInit): Promise<ConversationMessage> => {

  return customFetch<ConversationMessage>(getSendConversationMessageUrl(contactId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getSendConversationMessageMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendConversationMessage>>, TError,{contactId: number;data: BodyType<SendMessageBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendConversationMessage>>, TError,{contactId: number;data: BodyType<SendMessageBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendConversationMessage>>, {contactId: number;data: BodyType<SendMessageBody>}> = (props) => {
...
export const adminCreateUser = async (adminCreateUserBody: AdminCreateUserBody, options?: RequestInit): Promise<AdminCreateUserResponse> => {
